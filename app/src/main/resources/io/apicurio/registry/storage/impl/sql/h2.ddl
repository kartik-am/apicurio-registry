...
CREATE TABLE markdown (tenantId VARCHAR(128) NOT NULL, groupId VARCHAR(512), artifactId VARCHAR(512) NOT NULL, version VARCHAR(256) NOT NULL, content BYTEA NOT NULL);
